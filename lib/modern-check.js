...
// `qsp/game.c:399 qspCheckGameStatus` (@ 9f4f29f9), plus the container checks
// `qspOpenGameStatus` does before calling it.
//
...
(function (factory) {
  ...
  var GAMEMINVER = '5.9.0'; // libqsp CMakeLists.txt:4
  var VER = '5.9.0';        // libqsp CMakeLists.txt:2
  var MAXPLFILES = 500, MAXINCFILES = 100, MAXACTIONS = 50, MAXOBJECTS = 1000;
  var TYPES = 6;            // QSP_TYPE_DEFINED_TYPES (bindings/qsp.h:93)
  var BASE_TUPLE = 0, BASE_NUM = 1, BASE_STR = 2;
  var BASETYPE = [BASE_TUPLE, BASE_NUM, BASE_STR, BASE_STR, BASE_STR, BASE_STR];

  /**
   * @returns { ok: true } or { ok: false, reason: string }
   */
  function checkModernSav(input) {
    ...
    // qspStrsComp is a plain lexicographic compare (text.h:241)
